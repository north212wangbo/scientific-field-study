...
<frameset cols="200,*" frameborder="0" border="0" framespacing="0">
	<frame name="menu" src="menu_1.php?id=<?php echo $sID; ?>" marginheight="0" marginwidth="0" scrolling="auto" noresize>
	<frame name="content" src="content.php?id=<?php echo $sID; ?>" marginheight="0" marginwidth="0" scrolling="auto" noresize>
